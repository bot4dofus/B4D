...
public class Zaap extends Transport{
    ...
    public final static Zaap Astrub = new Zaap("Astrub (Cite d'astrub)", new Point(4, -19), new PointF(0.5407, 0.4037));
	...
	public Zaap(String nom, Point position, PointF positionF) {
