...
public class JPanel_Personnage extends JPanel {
	...
	public JPanel_Personnage() {
		...
		lblNomDeCompte.setBounds(10, 10, 150, 25);
		...
		lblNomDeCompte.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		textField.setBounds(10, 35, 150, 25);
		add(textField);
		...
		lblMotDePasse.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblMotDePasse.setBackground(new Color(46, 139, 87));
		lblMotDePasse.setBounds(165, 10, 150, 25);
		add(lblMotDePasse);
		
		textField_1 = new JTextField();
		textField_1.setFont(new Font("Tahoma", Font.PLAIN, 13));
		textField_1.setColumns(10);
		textField_1.setBounds(165, 35, 150, 25);
		add(textField_1);
		...
		lblServeur.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblServeur.setBackground(new Color(46, 139, 87));
		lblServeur.setBounds(320, 10, 150, 25);
		add(lblServeur);
		
		textField_2 = new JTextField();
		textField_2.setFont(new Font("Tahoma", Font.PLAIN, 13));
		textField_2.setColumns(10);
		textField_2.setBounds(320, 35, 150, 25);
		add(textField_2);
		...
		lblPseudo.setBounds(475, 10, 150, 25);
		add(lblPseudo);
		
		textField_3 = new JTextField();
		textField_3.setFont(new Font("Tahoma", Font.PLAIN, 13));
		textField_3.setColumns(10);
		textField_3.setBounds(475, 35, 150, 25);
		add(textField_3);
		
		table = new JTable();
		table.setBounds(10, 65, 615, 125);
		add(table);
		...
		panel_Potion_Rappel.setBounds(10, 195, 150, 130);
		...
		lblXY.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblXY.setBackground(Color.GRAY);
		lblXY.setBounds(0, 25, 150, 25);
		panel_Potion_Rappel.add(lblXY);
		
		JButton btnNewButton = new JButton("Modifier");
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 13));
		btnNewButton.setBackground(UIManager.getColor("Button.background"));
		btnNewButton.setBounds(5, 50, 140, 25);
		...
		panel_Potion_Bonta.setBounds(165, 195, 150, 130);
		...
		panel_Potion_Brakmar.setBounds(320, 195, 150, 130);
		...
		lblXY_2.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblXY_2.setBackground(Color.GRAY);
		lblXY_2.setBounds(0, 25, 150, 25);
		...
		panel_Sort.setBounds(475, 195, 150, 80);
		add(panel_Sort);
